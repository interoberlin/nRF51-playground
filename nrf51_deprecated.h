 ...
 * nRF51 Bitmasks
 *
 * This file specifies the bitmasks,
 * that must be used to make use of the processor's functions.
 *
 * Author: Nordic Semiconductor ASA
 *
 * This file is a mere presentation of facts
 * and therefore not copyrightable.
 *
 * THIS FILE IS DEPRECATED
 * USE nrf51_bitfields.h INSTEAD
 */
